...
const var Master1 = Synth.getEffect("Master1");
...
inline function onGainMasterControl(component, value)
{
	...
	Master1.setAttribute(Master1.Gain, value);
	Label1.set("text", GainMaster.getValue());
	Knob9.setValue(value);
	Knob9.changed();
...
{   
    ...
    {
        ParametriqEQ_X.setAttribute(ParametriqEQ_X.Gain  + 0 * ParametriqEQ_X.BandOffset, 0-DYNA_Compressor_Reduction_v);
    }
...
{   
    ...
    {
        ParametriqEQ_X.setAttribute(ParametriqEQ_X.Gain  + 1 * ParametriqEQ_X.BandOffset, 0-DYNA1_Compressor_Reduction_v);
    }
...
{   
    ...
    {
        ParametriqEQ_X.setAttribute(ParametriqEQ_X.Gain  + 2 * ParametriqEQ_X.BandOffset, 0-DYNA2_Compressor_Reduction_v);
    }
...
{   
    ...
    {
        ParametriqEQ_X.setAttribute(ParametriqEQ_X.Gain  + 3 * ParametriqEQ_X.BandOffset, 0-DYNA3_Compressor_Reduction_v);
    }
...
{   
    ...
    {
        ParametriqEQ_X.setAttribute(ParametriqEQ_X.Gain  + 4 * ParametriqEQ_X.BandOffset, 0-DYNA4_Compressor_Reduction_v);
    }
...
{   
    ...
    {
        ParametriqEQ_X.setAttribute(ParametriqEQ_X.Gain  + 5 * ParametriqEQ_X.BandOffset, 0-DYNA5_Compressor_Reduction_v);
    }
...
{   
    ...
    {
        ParametriqEQ_X.setAttribute(ParametriqEQ_X.Gain  + 6 * ParametriqEQ_X.BandOffset, 0-DYNA6_Compressor_Reduction_v);
    }
...
{   
    ...
    {
        ParametriqEQ_X.setAttribute(ParametriqEQ_X.Gain  + 7 * ParametriqEQ_X.BandOffset, 0-DYNA7_Compressor_Reduction_v);
    }
